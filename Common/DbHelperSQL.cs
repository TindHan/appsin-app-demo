...
namespace DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static string connectionString = "server=127.0.0.1;port=3306;user=root;password=htc123!@#; database=app_act;Allow User Variables=True";     		
        public DbHelperSQL()
        {            
        }
        ...
        private static MySqlCommand BuildIntCommand(MySqlConnection connection, string storedProcName, IDataParameter[] parameters)
        {
            ...
            command.Parameters.Add(
                new MySqlParameter("ReturnValue",MySqlDbType.Int32,4, ParameterDirection.ReturnValue,false, 0, 0, string.Empty, DataRowVersion.Default, null));
            return command;
        }
        #endregion
        ...
        public static DataSet QueryPageList(string TableName, string FieldKey, string FieldShow, int iPageSize, int iCurrentPage, string sColumnOrder, string sWhere, out int iRecordCount)
        {
            ...
            MySqlParameter[] parameters ={ 
				 new MySqlParameter("@tbname",MySqlDbType.VarChar,1000),
				 new MySqlParameter("@FieldKey",MySqlDbType.VarChar,200),
				 new MySqlParameter("@PageCurrent",MySqlDbType.Int32),
				 new MySqlParameter("@PageSize",MySqlDbType.Int32),
				 new MySqlParameter("@FieldShow",MySqlDbType.VarChar,2000),
				 new MySqlParameter("@FieldOrder",MySqlDbType.VarChar,1000),
				 new MySqlParameter("@Where",MySqlDbType.VarChar,1000),
				 new MySqlParameter("@RecordCount",MySqlDbType.Int32)};
